    ...
    public static class PauseMenu_Setup
    {
        ...
        public static class Menu_Start_Patch
        {
            ...
            public static void Postfix(Menu __instance)
            {
                ...
                var newMenu = Object.Instantiate(AugaLite.Assets.MenuPrefab, parent, false).GetComponent<Menu>();
        ...
        public static class TextsDialog_Patch
        {
            ...
            {
                __instance.m_textArea.text = __instance.m_textArea.text.Replace("color=yellow", $"color={AugaLite.Colors.Topic}");
            }
        }
    }
}
