    ...
    public static class Hud_Setup
    {
        ...
        public static void Hud_Awake_Postfix(Hud __instance)
        {
            ...
            */
            ...
            __instance.m_saveIcon = __instance.Replace("hudroot/SaveIcon", AugaLite.Assets.Hud).gameObject;
            ...
            */
            ...
            {
                // hide instead of destroy the object because destroying breaks other mods.
            ...
            __instance.m_staminaBar2Root.HideElement();
            __instance.m_eitrBarRoot.HideElement();
            
            var hudroot = __instance.transform.Find("hudroot");
            var foodPanel0 = hudroot.gameObject.CopyOver("hudroot/FoodPanel0", AugaLite.Assets.Hud, 5);
            var foodPanel1 = hudroot.gameObject.CopyOver("hudroot/FoodPanel1", AugaLite.Assets.Hud, 6);
            var foodPanel2 = hudroot.gameObject.CopyOver("hudroot/FoodPanel2", AugaLite.Assets.Hud, 7);
            var newHealthPanel = hudroot.gameObject.CopyOver("hudroot/HealthBar", AugaLite.Assets.Hud, 8);
            var newStaminaPanel = hudroot.gameObject.CopyOver("hudroot/StaminaBar", AugaLite.Assets.Hud, 9);
            var newEitrPanel = hudroot.gameObject.CopyOver("hudroot/EitrBar", AugaLite.Assets.Hud, 10);
            ...
            __instance.m_actionBarRoot = __instance.Replace("hudroot/action_progress", AugaLite.Assets.Hud).gameObject;
            ...
            var newStaggerPanel = __instance.Replace("hudroot/staggerpanel", AugaLite.Assets.Hud);
    ...
    */
    ...
    public static class Hud_UpdateCrosshair_Patch
    {
        ...
        public static void Postfix(Hud __instance)
        {
            ...
            {
                ColorUtility.TryParseHtmlString(AugaLite.Colors.BrightestGold, out var brightestGold);
    ...
    public static class Hud_UpdateBuild_Patch
    {
        ...
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            foreach (var instruction in instructions)
            {
                ...
                {
                    yield return new CodeInstruction(OpCodes.Ldstr, $" [<color={AugaLite.Colors.BrightestGold}>");
                }
                else
                {
