...
//[BepInDependency("org.bepinex.plugins.jewelcrafting", BepInDependency.DependencyFlags.SoftDependency)]
    public class AugaLite : BaseUnityPlugin
    {
        ...
        public const string Version = "1.0.4"; // forked from Auga 1.3.11
...
*/
        ...
        private void LoadDependencies()
        {
            ...
            LoadEmbeddedAssembly(assembly, "Unity.AugaLite.dll");
        }
...
//            Assets.BuildHud = assetBundle.LoadAsset<GameObject>("BuildHud");
        ...
        public static string GetAssetPath(string assetName)
        {
            ...
            {
                var assembly = typeof(AugaLite).Assembly;
        ...
        public static void UpdateStatBars()
        {
            if (Hud.instance != null)
            {
                ...
                if (newHealthPanel != null && newHealthPanel.GetComponent<AugaHealthBar>() is AugaHealthBar healthBar)
                {
                    ...
                    healthBar.FixedLength = AugaLite.HealthBarFixedSize.Value;
                    healthBar.TextDisplay = (AugaHealthBar.TextDisplayMode)AugaLite.HealthBarTextDisplay.Value;
                    healthBar.DisplayTextPosition = (AugaHealthBar.TextPosition)AugaLite.HealthBarTextPosition.Value;
                ...
                if (newStaminaPanel != null && newStaminaPanel.GetComponent<AugaHealthBar>() is AugaHealthBar staminaBar)
                {
                    ...
                    staminaBar.FixedLength = AugaLite.StaminaBarFixedSize.Value;
                    staminaBar.TextDisplay = (AugaHealthBar.TextDisplayMode)AugaLite.StaminaBarTextDisplay.Value;
                    staminaBar.DisplayTextPosition = (AugaHealthBar.TextPosition)AugaLite.StaminaBarTextPosition.Value;
                ...
                if (newEitrPanel != null && newEitrPanel.GetComponent<AugaHealthBar>() is AugaHealthBar eitrBar)
                {
                    ...
                    eitrBar.FixedLength = AugaLite.EitrBarFixedSize.Value;
                    eitrBar.TextDisplay = (AugaHealthBar.TextDisplayMode)AugaLite.EitrBarTextDisplay.Value;
                    eitrBar.DisplayTextPosition = (AugaHealthBar.TextPosition)AugaLite.EitrBarTextPosition.Value;
