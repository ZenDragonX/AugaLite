...
public static class Minimap_Setup
{
    ...
    public static void Minimap_Start_Postfix(Minimap __instance)
    {
        ...
        // TODO: fix bug where minimap small always shows even when world modifier nomap is enabled.
        var newMiniMap = Hud.instance.Replace("hudroot/MiniMap/small", AugaLite.Assets.Hud);
        ...
        var newMap = Hud.instance.Replace("hudroot/MiniMap/large", AugaLite.Assets.Hud);
