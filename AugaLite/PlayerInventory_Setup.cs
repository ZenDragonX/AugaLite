    ...
    public static class InventoryPanel_Patches
    {
        ...
        public static class InventoryGui_Awake_Patch
        {
            ...
            public static void Postfix(InventoryGui __instance)
            {
                ...
                var playerInventory = __instance.Replace("root/Player", AugaLite.Assets.InventoryScreen, "root/Player");
                ...
                var containerInventory = __instance.Replace("root/Container", AugaLite.Assets.InventoryScreen, "root/Container");
                ...
                var variantDialog = __instance.Replace("root/VariantDialog", AugaLite.Assets.InventoryScreen, "root/DummyObjects/DummyVariantDialog");
                __instance.m_variantDialog = variantDialog.GetComponent<VariantDialog>();

                var skillsDialog = __instance.Replace("root/Skills", AugaLite.Assets.InventoryScreen, "root/RightPanel/TabContent/TabContent_Skills");
                ...
                var rightPanel = Object.Instantiate(AugaLite.Assets.InventoryScreen.transform.Find("root/RightPanel"), containerInventory.parent, false);
                ...
                CraftingPanel.SetMultiCraftEnabled(AugaLite.HasMultiCraft);
                ...
                var splitDialog = __instance.Replace("root/SplitDialog", AugaLite.Assets.InventoryScreen, "root/SplitDialog");
                ...
                var newAnimator = AugaLite.Assets.InventoryScreen.GetComponent<Animator>();
                ...
                standardDivider.gameObject.SetActive(!AugaLite.UseAugaTrash.Value);
                trashDivider.gameObject.SetActive(AugaLite.UseAugaTrash.Value);
