...
namespace AugaLite
{
    ...
    public static class API
    {
        ...
        {
#if ! API
            return AugaLite.Assets.SourceSansProBold;
#else
            return null;
#endif
        }
        ...
        {
#if ! API
            return AugaLite.Assets.SourceSansProSemiBold;
#else
            return null;
#endif
        }
        ...
        {
#if ! API
            return AugaLite.Assets.SourceSansProRegular;
#else
            return null;
#endif
        }
        ...
        {
#if ! API
            return AugaLite.Assets.ItemBackgroundSprite;
#else
            return null;
#endif
        }
        ...
        {
#if ! API
            var panel = Object.Instantiate(AugaLite.Assets.PanelBase, parent);
            if (AugaLite.Assets.PanelBase == null)
            {
                AugaLite.LogError($"Auga.Assets.PanelBase is null");
                Thread.Sleep(25000);
            }
            panel.name = name;
        ...
        {
#if ! API
            var button = Object.Instantiate(AugaLite.Assets.ButtonSmall, parent);
            button.name = name;
        ...
        {
#if ! API
            var button = Object.Instantiate(AugaLite.Assets.ButtonMedium, parent);
            button.name = name;
            var text = button.GetComponentInChildren<TMP_Text>();
            if (text != null)
            {
        ...
        {
#if ! API
            var button = Object.Instantiate(AugaLite.Assets.ButtonFancy, parent);
            button.name = name;
            var text = button.GetComponentInChildren<TMP_Text>();
            if (text != null)
            {
        ...
        {
#if ! API
            var button = Object.Instantiate(AugaLite.Assets.ButtonSettings, parent);
            button.name = name;
            var text = button.GetComponentInChildren<TMP_Text>();
            if (text != null)
            {
        ...
        {
#if ! API
            var button = Object.Instantiate(AugaLite.Assets.DiamondButton, parent);
            button.name = name;
        ...
        {
#if ! API
            var divider = Object.Instantiate(AugaLite.Assets.DividerSmall, parent);
            divider.name = name;
            if (width >= 0)
            {
        ...
        {
#if ! API
            var divider = Object.Instantiate(AugaLite.Assets.DividerMedium, parent);
            divider.name = name;
            if (width >= 0)
            {
                divider.RectTransform().SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, width);
        ...
        {
#if ! API
            var divider = Object.Instantiate(AugaLite.Assets.DividerLarge, parent);
            divider.name = name;
            if (width >= 0)
            {
                divider.RectTransform().SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, width);
        ...
        public static void Tooltip_MakeSimpleTooltip(GameObject obj)
        {
            ...
            uiTooltip.m_tooltipPrefab = AugaLite.Assets.SimpleTooltip;
#endif
        }
        ...
        public static void Tooltip_MakeItemTooltip(GameObject obj, ItemDrop.ItemData item)
        {
            ...
            uiTooltip.m_tooltipPrefab = AugaLite.Assets.InventoryTooltip;
        ...
        private static bool TextBoxCheck(GameObject tooltipTextBoxGO, out TooltipTextBox tooltipTextBox)
        {
            ...
            {
                AugaLite.LogError("Must call TooltipTextBox interface method with a game object with a TooltipTextBox component on it.");
                return false;
            }
        ...
        private static bool ComplexTooltipCheck(GameObject complexTooltipGO, out ComplexTooltip complexTooltip)
        {
            ...
            {
                AugaLite.LogError("Must call ComplexTooltip interface method with a game object with a ComplexTooltip component on it.");
                return false;
            }
        ...
        private static bool RequirementsPanelCheck(GameObject requirementsPanelGO, out CraftingRequirementsPanel requirementsPanel)
        {
            ...
            {
                AugaLite.LogError("Must call RequirementsPanel interface method with a game object with a CraftingRequirementsPanel component on it.");
                return false;
            }
